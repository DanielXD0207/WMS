<?php 
    ...
    $select = mysqli_query($conn, "SELECT * FROM vw_order_lists WHERE Status <> 'Returned' AND Delivered_Date >= CURRENT_DATE - INTERVAL 6 DAY AND MONTH(Delivered_Date) = MONTH(CURRENT_DATE)");
...
<table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <button class="btn btn-view" id="btn" onclick="getDailyOrderData('<?php echo $list['Order_ID']; ?>');">
