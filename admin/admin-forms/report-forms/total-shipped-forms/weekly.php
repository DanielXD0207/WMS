<?php 
    ...
    $select = mysqli_query($conn, "SELECT * FROM vw_order_lists WHERE Status <> 'Returned' AND Delivered_Date < DATE_SUB(NOW(), INTERVAL 1 WEEK) AND MONTH(Delivered_Date) = MONTH(CURRENT_DATE) AND YEAR(Delivered_Date) = YEAR(CURRENT_DATE) ");
...
<table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <button class="btn btn-view" id="btn" onclick="getWeeklyOrderData('<?php echo $list['Order_ID']; ?>');">
