...
<table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <button class="btn btn-view" id="btn" onclick="getReturnedOrderData('<?php echo $list['Order_ID']; ?>');">
...
<button class="btn btn-secondary viewbtn" onclick="returnedBack();"><i class="bi bi-arrow-return-left"></i>Back</button>
